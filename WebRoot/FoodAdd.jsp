...
<body>
<div class="pd-20">
  <form action="AddFood.action" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>菜名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="name" placeholder="" id="" name="food.fname" datatype="*2-16" nullmsg="菜名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="price" name="food.fprice" datatype="*2-16" nullmsg="价格不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="des" name="food.fdes" datatype="*2-16" nullmsg="描述不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="ku" name="food.stock" datatype="*2-16" nullmsg="库存不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
